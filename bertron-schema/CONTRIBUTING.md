# Contributing to bertron-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
bertron-schema. These guidelines are not strict rules.
...
The bertron-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the bertron-schema technical leads
...
[issues]: https://github.com/ber-data/bertron-schema/issues/
[pulls]: https://github.com/ber-data/bertron-schema/pulls/
