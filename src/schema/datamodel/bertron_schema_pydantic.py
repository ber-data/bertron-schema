...
class DataTypeTagType(str, Enum):
    """
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "slot_usage": {
                ...
                "has_unit": {"description": "The unit of the quantity", "name": "has_unit"},
            },
        }
    )
...
class Entity(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"class_uri": "schema:Thing", "from_schema": "https://w3id.org/ber-data/bertron-schema"}
    )

    ber_data_source: BERSourceType = Field(
        default=...,
        description="""The BER member from whence the entity originated.""",
        json_schema_extra={"linkml_meta": {"alias": "ber_data_source", "domain_of": ["Entity"]}},
    )
    ...
    altitude: QuantityValue | None = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                "alias": "altitude",
                "annotations": {
                    "expected_value": {"tag": "expected_value", "value": "measurement value"}
                },
...
class DataCollection(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "comments": ["May be equivalent to FundingReference in the CreditMetadata schema."],
            "from_schema": "https://w3id.org/ber-data/bertron-schema",
        }
    )
    ...
    url: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"alias": "url", "domain_of": ["DataCollection"]}},
    )
